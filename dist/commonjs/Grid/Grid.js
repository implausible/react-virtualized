...
var Grid = function (_Component) {
  ...
  function Grid(props, context) {
    ...
    _this._onWheelHandler = _this._onWheelHandler.bind(_this);
    _this._onThrottledWheel = (0, _lodash2.default)(_this._onWheelHandler, 1000 / 60);
  ...
  _createClass(Grid, [{
    ...
    key: '_onWheelHandler',
    value: function _onWheelHandler(deltaX, deltaY) {
      ...
      var totalRowsHeight = this._rowSizeAndPositionManager.getTotalSize();
      var totalColumnsWidth = this._columnSizeAndPositionManager.getTotalSize();
      var scrollLeft = Math.min(Math.max(0, totalColumnsWidth - width + scrollbarSize), Math.max(0, this._scrollingContainer.scrollLeft + deltaX));
      var scrollTop = Math.min(Math.max(0, totalRowsHeight - height + scrollbarSize), Math.max(0, this._scrollingContainer.scrollTop + deltaY));
